...
/// Consolidates image metadata extraction using a streaming reader.
...
/// Consolidates audio metadata extraction using a streaming reader.
...
/// Consolidates video metadata extraction using a streaming reader.
